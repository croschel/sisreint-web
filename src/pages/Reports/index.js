...
function Reports() {
  ...
  function handleTreatmentReport() {
    history.push('/treatments_report', { referencia: { year: anoReferencia, month: mesReferencia } });
  }
  ...
  return (
    <>
      ...
      <Container>
        ...
        <button id="first-button" onClick={handleTreatmentReport}>Tratamento dos militares Reintegrados por Decisão judicial</button>
        <button id="second-button" onClick={handleMilitariesReport}>Ficha de informações de militares em situação especial</button>
      </Container>
    </>
  );
}
